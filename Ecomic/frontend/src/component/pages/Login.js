...
function Login() {
    ...
    const svgMarkup = `
    <svg fill="#00D6BB" width="80px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 46.939 46.94" xml:space="preserve">
  ...
  `;
    let onSubmitHandler = (evt)=>{
        evt.preventDefault();
        console.log(username,password);
    }
    let onKeyupHandler = (evt)=>{
        let clName = evt.currentTarget.className;
            ...
            <div className='content-wrapper'>
                <form>
                    ...
                    <div className='btn-wrapper'>
                        <button className='submit_button' onClick={onSubmitHandler}>Submit</button>
                    </div>
                </form>
